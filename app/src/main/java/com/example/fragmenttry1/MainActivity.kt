package com.example.fragmenttry1
...
import com.example.fragmenttry1.Fragments.GalleryFragment
import com.example.fragmenttry1.Fragments.ImportFragment
    ...
    ImportFragment.OnFragmentInteractionListener, GalleryFragment.OnFragmentInteractionListener
{
    override fun onFragmentInteraction(uri: Uri) {
        ...
        Log.d("Armory", "On Fragment Interaction")
        ...
        when (item.itemId) {
            R.id.nav_camera -> {
                ...
                supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.container_id, importFragment)
            ...
            R.id.nav_gallery -> {
                ...
                supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.container_id, galleryFragment)
